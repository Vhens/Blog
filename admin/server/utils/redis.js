...
async function createForgetUser(account, activeKey) {
  if (common.isEmpty(account, activeKey)) {
...
async function addUser(params) {
  if (common.isEmpty(params, params._id)) {
...
async function thumbsUpById(params) {
  if (common.isEmpty(params, params.commentId, params.userId)) {
...
async function reportCommentById(commentId, userId) {
  if (common.isEmpty(commentId, userId)) {
...
async function reportSubCommentById(params) {
  if (common.isEmpty(params, params.userId, params.commentId, params.parentId)) {
...
async function deleteSubComment(parentId, commentId) {
  if (common.isEmpty(parentId, commentId)) {
...
async function setTopPreviewArticle(params) {
  if (common.isEmpty(params, params._id, params.title, params.pv)) {
...
async function delTopPreviewArticle(params) {
  if (common.isEmpty(params, params._id, params.title)) {
...
async function incPv(params) {
  if (common.isEmpty(params, params.articleId, params.title)) {
...
async function setArticleCatalogs(catalog, count) {
  if (common.isEmpty(catalog, count)) {
...
async function setTopCommentsArticle(params) {
  if (common.isEmpty(params, params._id, params.title, params.commentCount)) {
...
async function setCommentCount(articleId, title, num) {
  if (common.isEmpty(articleId, title, num)) {
...
async function addReportedComment(params) {
  if (common.isEmpty(params, params._id, params.parentId)) {
